                    ...
                    TextButton(
                      onPressed: () {
                        _showRepurchaseBottomSheet(context, (price, qty, dt) {
                          ...
                          provider
                              .rePurchase(pid, price, qty, dt, product.category,
                                  product.stock)
                              .then((value) {
      ...
      builder: (context) => ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            trailing: Text('Purchase Price: $currencySymbol${purModel.price}'),
          );
        },
      ),
    );
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                      filled: true, hintText: 'Purchase Price'),
                ),
                const SizedBox(
                  height: 10,
                ),
                TextField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration:
                      const InputDecoration(filled: true, hintText: 'Quantity'),
                ),
                Card(
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      TextButton(
                        onPressed: () async {
                          dateTimeNotifier.value = await _selectDate(context);
                        },
                ...
                ElevatedButton(
                  onPressed: () {
                    onSave(num.parse(pController.text),
                        num.parse(qController.text), dateTimeNotifier.value);
                    //Navigator.pop(context);
                  },
                  child: const Text('Re-Purchase'),
                ),
